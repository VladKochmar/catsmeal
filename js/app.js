(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelectorAll(".slider-restaurants").length) document.querySelectorAll(".slider-restaurants").forEach((n => {
                if (n.querySelector(".slider-restaurants__slider")) {
                    new core(n.querySelector(".slider-restaurants__slider"), {
                        ...
                        lazy: true,
                        scrollbar: {
                            el: n.querySelector(".slider-restaurants-scrollbar"),
                            draggable: true
                        },
                        navigation: {
                            prevEl: n.querySelector(".slider-restaurants-prev"),
                            nextEl: n.querySelector(".slider-restaurants-next")
                        },
                        breakpoints: {
                            320: {
                                slidesPerView: 1.5,
            ...
            if (document.querySelector(".form-order__slider")) {
                const swiper = new core(".form-order__slider", {
                    ...
                    navigation: {
                        prevEl: ".slide-order-prev",
                        nextEl: ".slide-order-next"
                    },
                    on: {}
                });
                let sliderTotal = document.querySelector(".fraction-form-order__total");
                let sliderCurrent = document.querySelector(".fraction-form-order__current");
                sliderTotal.innerHTML = swiper.slides.length;
